...
type CallerID struct {
	...
	xxx_hidden_Principal    string                 `protobuf:"bytes,1,opt,name=principal,proto3"`
	xxx_hidden_Component    string                 `protobuf:"bytes,2,opt,name=component,proto3"`
	xxx_hidden_Subcomponent string                 `protobuf:"bytes,3,opt,name=subcomponent,proto3"`
	xxx_hidden_Groups       []string               `protobuf:"bytes,4,rep,name=groups,proto3"`
...
func (x *CallerID) GetSubcomponent() string {
	if x != nil {
		return x.xxx_hidden_Subcomponent
	}
	return ""
}
...
func (x *CallerID) SetPrincipal(v string) {
	x.xxx_hidden_Principal = v
}

func (x *CallerID) SetComponent(v string) {
	x.xxx_hidden_Component = v
}

func (x *CallerID) SetSubcomponent(v string) {
	x.xxx_hidden_Subcomponent = v
}

func (x *CallerID) SetGroups(v []string) {
	x.xxx_hidden_Groups = v
}

type CallerID_builder struct {
...
func (b0 CallerID_builder) Build() *CallerID {
	m0 := &CallerID{}
	b, x := &b0, m0
	_, _ = b, x
	x.xxx_hidden_Principal = b.Principal
	x.xxx_hidden_Component = b.Component
	x.xxx_hidden_Subcomponent = b.Subcomponent
...
type RPCError struct {
	...
	xxx_hidden_Code    Code                   `protobuf:"varint,2,opt,name=code,proto3,enum=mtrpc.Code"`
	unknownFields      protoimpl.UnknownFields
	sizeCache          protoimpl.SizeCache
}
...
func (x *RPCError) SetMessage(v string) {
	x.xxx_hidden_Message = v
}

func (x *RPCError) SetCode(v Code) {
	x.xxx_hidden_Code = v
}
