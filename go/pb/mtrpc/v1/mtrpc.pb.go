...
func (Code) Descriptor() protoreflect.EnumDescriptor {
	return file_mtrpc_v1_mtrpc_proto_enumTypes[0].Descriptor()
}

func (Code) Type() protoreflect.EnumType {
	return &file_mtrpc_v1_mtrpc_proto_enumTypes[0]
}
...
func (Code) EnumDescriptor() ([]byte, []int) {
	return file_mtrpc_v1_mtrpc_proto_rawDescGZIP(), []int{0}
}
...
func (x *CallerID) Reset() {
	*x = CallerID{}
	mi := &file_mtrpc_v1_mtrpc_proto_msgTypes[0]
...
type RPCError struct {
	...
	Code          Code                   `protobuf:"varint,2,opt,name=code,proto3,enum=mtrpc.v1.Code" json:"code,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *RPCError) Reset() {
	*x = RPCError{}
	mi := &file_mtrpc_v1_mtrpc_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*RPCError) Descriptor() ([]byte, []int) {
	return file_mtrpc_v1_mtrpc_proto_rawDescGZIP(), []int{1}
}
...
var File_mtrpc_v1_mtrpc_proto protoreflect.FileDescriptor

const file_mtrpc_v1_mtrpc_proto_rawDesc = "" +
	"\n" +
	"\x14mtrpc/v1/mtrpc.proto\x12\bmtrpc.v1\"\x82\x01\n" +
	"\bCallerID\x12\x1c\n" +
	...
	"\x04code\x18\x02 \x01(\x0e2\x0e.mtrpc.v1.CodeR\x04code*\xd8\x02\n" +
	"\x04Code\x12\x06\n" +
	"\x02OK\x10\x00\x12\f\n" +
	...
	"\tREAD_ONLY\x10\x12B/Z-github.com/multigres/multigres/go/pb/mtrpc/v1b\x06proto3"

var (
	file_mtrpc_v1_mtrpc_proto_rawDescOnce sync.Once
	file_mtrpc_v1_mtrpc_proto_rawDescData []byte
)

func file_mtrpc_v1_mtrpc_proto_rawDescGZIP() []byte {
	file_mtrpc_v1_mtrpc_proto_rawDescOnce.Do(func() {
		file_mtrpc_v1_mtrpc_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_mtrpc_v1_mtrpc_proto_rawDesc), len(file_mtrpc_v1_mtrpc_proto_rawDesc)))
	})
	return file_mtrpc_v1_mtrpc_proto_rawDescData
}

var file_mtrpc_v1_mtrpc_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_mtrpc_v1_mtrpc_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_mtrpc_v1_mtrpc_proto_goTypes = []any{
	(Code)(0),        // 0: mtrpc.v1.Code
	(*CallerID)(nil), // 1: mtrpc.v1.CallerID
	(*RPCError)(nil), // 2: mtrpc.v1.RPCError
}
var file_mtrpc_v1_mtrpc_proto_depIdxs = []int32{
	0, // 0: mtrpc.v1.RPCError.code:type_name -> mtrpc.v1.Code
...
func init() { file_mtrpc_v1_mtrpc_proto_init() }
func file_mtrpc_v1_mtrpc_proto_init() {
	if File_mtrpc_v1_mtrpc_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_mtrpc_v1_mtrpc_proto_rawDesc), len(file_mtrpc_v1_mtrpc_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_mtrpc_v1_mtrpc_proto_goTypes,
		DependencyIndexes: file_mtrpc_v1_mtrpc_proto_depIdxs,
		EnumInfos:         file_mtrpc_v1_mtrpc_proto_enumTypes,
		MessageInfos:      file_mtrpc_v1_mtrpc_proto_msgTypes,
	}.Build()
	File_mtrpc_v1_mtrpc_proto = out.File
	file_mtrpc_v1_mtrpc_proto_goTypes = nil
	file_mtrpc_v1_mtrpc_proto_depIdxs = nil
}
