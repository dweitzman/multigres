...
type PoolerHealthState struct {
	...
	// Most recent rule + LSN
	NodePosition  *clustermetadata.NodePosition `protobuf:"bytes,15,opt,name=node_position,json=nodePosition,proto3" json:"node_position,omitempty"`
...
func (x *PoolerHealthState) GetNodePosition() *clustermetadata.NodePosition {
	if x != nil {
...
const file_multiorchdata_proto_rawDesc = "" +
	"\n" +
	"\x13multiorchdata.proto\x12\rmultiorchdata\x1a\x15clustermetadata.proto\x1a\x13consensusdata.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1cmultipoolermanagerdata.proto\"\xcb\a\n" +
	...
	"\x10consensus_status\x18\x0e \x01(\v2\x1d.consensusdata.StatusResponseR\x0fconsensusStatus\x12B\n" +
	"\rnode_position\x18\x0f \x01(\v2\x1d.clustermetadata.NodePositionR\fnodePositionB4Z2github.com/multigres/multigres/go/pb/multiorchdatab\x06proto3"
...
var file_multiorchdata_proto_goTypes = []any{
	...
	(*clustermetadata.NodePosition)(nil),                    // 8: clustermetadata.NodePosition
}
var file_multiorchdata_proto_depIdxs = []int32{
	...
	8,  // 9: multiorchdata.PoolerHealthState.node_position:type_name -> clustermetadata.NodePosition
