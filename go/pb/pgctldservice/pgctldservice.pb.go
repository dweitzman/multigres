...
const (
	...
	DatabaseClusterState_DATABASE_CLUSTER_STATE_SHUT_DOWN             DatabaseClusterState = 2 // shut down
	DatabaseClusterState_DATABASE_CLUSTER_STATE_SHUT_DOWN_IN_RECOVERY DatabaseClusterState = 3 // shut down in recovery
	DatabaseClusterState_DATABASE_CLUSTER_STATE_IN_PRODUCTION         DatabaseClusterState = 4 // in production
	DatabaseClusterState_DATABASE_CLUSTER_STATE_SHUTTING_DOWN         DatabaseClusterState = 5 // shutting down
	DatabaseClusterState_DATABASE_CLUSTER_STATE_IN_CRASH_RECOVERY     DatabaseClusterState = 6 // in crash recovery
)
