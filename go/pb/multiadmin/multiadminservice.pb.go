...
const file_multiadminservice_proto_rawDesc = "" +
	...
	"\x14BACKUP_STATUS_FAILED\x10\x032\x9a\t\n" +
	"\x11MultiAdminService\x12\\\n" +
	"\aGetCell\x12\x1a.multiadmin.GetCellRequest\x1a\x1b.multiadmin.GetCellResponse\"\x18\x82\xd3\xe4\x93\x02\x12\x12\x10/v1/cells/{name}\x12l\n" +
	"\vGetDatabase\x12\x1e.multiadmin.GetDatabaseRequest\x1a\x1f.multiadmin.GetDatabaseResponse\"\x1c\x82\xd3\xe4\x93\x02\x16\x12\x14/v1/databases/{name}\x12d\n" +
	"\fGetCellNames\x12\x1f.multiadmin.GetCellNamesRequest\x1a .multiadmin.GetCellNamesResponse\"\x11\x82\xd3\xe4\x93\x02\v\x12\t/v1/cells\x12t\n" +
	"\x10GetDatabaseNames\x12#.multiadmin.GetDatabaseNamesRequest\x1a$.multiadmin.GetDatabaseNamesResponse\"\x15\x82\xd3\xe4\x93\x02\x0f\x12\r/v1/databases\x12d\n" +
	"\vGetGateways\x12\x1e.multiadmin.GetGatewaysRequest\x1a\x1f.multiadmin.GetGatewaysResponse\"\x14\x82\xd3\xe4\x93\x02\x0e\x12\f/v1/gateways\x12`\n" +
	"\n" +
	"GetPoolers\x12\x1d.multiadmin.GetPoolersRequest\x1a\x1e.multiadmin.GetPoolersResponse\"\x13\x82\xd3\xe4\x93\x02\r\x12\v/v1/poolers\x12X\n" +
	"\bGetOrchs\x12\x1b.multiadmin.GetOrchsRequest\x1a\x1c.multiadmin.GetOrchsResponse\"\x11\x82\xd3\xe4\x93\x02\v\x12\t/v1/orchs\x12W\n" +
	"\x06Backup\x12\x19.multiadmin.BackupRequest\x1a\x1a.multiadmin.BackupResponse\"\x16\x82\xd3\xe4\x93\x02\x10:\x01*\"\v/v1/backups\x12x\n" +
	"\x11RestoreFromBackup\x12$.multiadmin.RestoreFromBackupRequest\x1a%.multiadmin.RestoreFromBackupResponse\"\x16\x82\xd3\xe4\x93\x02\x10:\x01*\"\v/v1/restore\x12\x85\x01\n" +
	"\x12GetBackupJobStatus\x12%.multiadmin.GetBackupJobStatusRequest\x1a&.multiadmin.GetBackupJobStatusResponse\" \x82\xd3\xe4\x93\x02\x1a\x12\x18/v1/backup-jobs/{job_id}\x12`\n" +
	"\n" +
	"GetBackups\x12\x1d.multiadmin.GetBackupsRequest\x1a\x1e.multiadmin.GetBackupsResponse\"\x13\x82\xd3\xe4\x93\x02\r\x12\v/v1/backupsB1Z/github.com/multigres/multigres/go/pb/multiadminb\x06proto3"
