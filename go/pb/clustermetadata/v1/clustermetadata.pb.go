...
// 	protoc        v4.25.1
// source: clustermetadata/v1/clustermetadata.proto
...
func (PoolerType) Descriptor() protoreflect.EnumDescriptor {
	return file_clustermetadata_v1_clustermetadata_proto_enumTypes[0].Descriptor()
}

func (PoolerType) Type() protoreflect.EnumType {
	return &file_clustermetadata_v1_clustermetadata_proto_enumTypes[0]
}
...
func (PoolerType) EnumDescriptor() ([]byte, []int) {
	return file_clustermetadata_v1_clustermetadata_proto_rawDescGZIP(), []int{0}
}
...
func (PoolerServingStatus) Descriptor() protoreflect.EnumDescriptor {
	return file_clustermetadata_v1_clustermetadata_proto_enumTypes[1].Descriptor()
}

func (PoolerServingStatus) Type() protoreflect.EnumType {
	return &file_clustermetadata_v1_clustermetadata_proto_enumTypes[1]
}
...
func (PoolerServingStatus) EnumDescriptor() ([]byte, []int) {
	return file_clustermetadata_v1_clustermetadata_proto_rawDescGZIP(), []int{1}
}
...
func (ID_ComponentType) Descriptor() protoreflect.EnumDescriptor {
	return file_clustermetadata_v1_clustermetadata_proto_enumTypes[2].Descriptor()
}

func (ID_ComponentType) Type() protoreflect.EnumType {
	return &file_clustermetadata_v1_clustermetadata_proto_enumTypes[2]
}
...
func (ID_ComponentType) EnumDescriptor() ([]byte, []int) {
	return file_clustermetadata_v1_clustermetadata_proto_rawDescGZIP(), []int{6, 0}
}
...
func (x *GlobalTopoConfig) Reset() {
	*x = GlobalTopoConfig{}
	mi := &file_clustermetadata_v1_clustermetadata_proto_msgTypes[0]
...
func (x *Cell) Reset() {
	*x = Cell{}
	mi := &file_clustermetadata_v1_clustermetadata_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *Database) Reset() {
	*x = Database{}
	mi := &file_clustermetadata_v1_clustermetadata_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Database) Descriptor() ([]byte, []int) {
	return file_clustermetadata_v1_clustermetadata_proto_rawDescGZIP(), []int{2}
}
...
type MultiPooler struct {
	...
	Type PoolerType `protobuf:"varint,6,opt,name=type,proto3,enum=clustermetadata.v1.PoolerType" json:"type,omitempty"`
	// PoolerServingStatus is the current type of the pooler.
	ServingStatus PoolerServingStatus `protobuf:"varint,7,opt,name=serving_status,json=servingStatus,proto3,enum=clustermetadata.v1.PoolerServingStatus" json:"serving_status,omitempty"`
...
func (x *MultiPooler) Reset() {
	*x = MultiPooler{}
	mi := &file_clustermetadata_v1_clustermetadata_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MultiPooler) Descriptor() ([]byte, []int) {
	return file_clustermetadata_v1_clustermetadata_proto_rawDescGZIP(), []int{3}
}
...
func (x *MultiGateway) Reset() {
	*x = MultiGateway{}
	mi := &file_clustermetadata_v1_clustermetadata_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MultiGateway) Descriptor() ([]byte, []int) {
	return file_clustermetadata_v1_clustermetadata_proto_rawDescGZIP(), []int{4}
}
...
func (x *MultiOrch) Reset() {
	*x = MultiOrch{}
	mi := &file_clustermetadata_v1_clustermetadata_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MultiOrch) Descriptor() ([]byte, []int) {
	return file_clustermetadata_v1_clustermetadata_proto_rawDescGZIP(), []int{5}
}
...
type ID struct {
	...
	Component ID_ComponentType `protobuf:"varint,1,opt,name=component,proto3,enum=clustermetadata.v1.ID_ComponentType" json:"component,omitempty"`
...
func (x *ID) Reset() {
	*x = ID{}
	mi := &file_clustermetadata_v1_clustermetadata_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ID) Descriptor() ([]byte, []int) {
	return file_clustermetadata_v1_clustermetadata_proto_rawDescGZIP(), []int{6}
}
...
func (x *KeyRange) Reset() {
	*x = KeyRange{}
	mi := &file_clustermetadata_v1_clustermetadata_proto_msgTypes[7]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KeyRange) Descriptor() ([]byte, []int) {
	return file_clustermetadata_v1_clustermetadata_proto_rawDescGZIP(), []int{7}
}
...
var File_clustermetadata_v1_clustermetadata_proto protoreflect.FileDescriptor

const file_clustermetadata_v1_clustermetadata_proto_rawDesc = "" +
	"\n" +
	"(clustermetadata/v1/clustermetadata.proto\x12\x12clustermetadata.v1\"y\n" +
	...
	"\x05cells\x18\x04 \x03(\tR\x05cells\"\xe8\x03\n" +
	"\vMultiPooler\x12&\n" +
	"\x02id\x18\x01 \x01(\v2\x16.clustermetadata.v1.IDR\x02id\x12\x1a\n" +
	"\bdatabase\x18\x02 \x01(\tR\bdatabase\x12\x1f\n" +
	"\vtable_group\x18\x03 \x01(\tR\n" +
	"tableGroup\x12\x14\n" +
	"\x05shard\x18\x04 \x01(\tR\x05shard\x129\n" +
	"\tkey_range\x18\x05 \x01(\v2\x1c.clustermetadata.v1.KeyRangeR\bkeyRange\x122\n" +
	"\x04type\x18\x06 \x01(\x0e2\x1e.clustermetadata.v1.PoolerTypeR\x04type\x12N\n" +
	"\x0eserving_status\x18\a \x01(\x0e2'.clustermetadata.v1.PoolerServingStatusR\rservingStatus\x12\x1a\n" +
	"\bhostname\x18\b \x01(\tR\bhostname\x12G\n" +
	"\bport_map\x18\t \x03(\v2,.clustermetadata.v1.MultiPooler.PortMapEntryR\aportMap\x1a:\n" +
	"\fPortMapEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\x05R\x05value:\x028\x01\"\xd8\x01\n" +
	"\fMultiGateway\x12&\n" +
	"\x02id\x18\x01 \x01(\v2\x16.clustermetadata.v1.IDR\x02id\x12\x1a\n" +
	"\bhostname\x18\x02 \x01(\tR\bhostname\x12H\n" +
	"\bport_map\x18\x03 \x03(\v2-.clustermetadata.v1.MultiGateway.PortMapEntryR\aportMap\x1a:\n" +
	"\fPortMapEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	...
	"\bport_map\x18\x03 \x03(\v2*.clustermetadata.v1.MultiOrch.PortMapEntryR\aportMap\x1a:\n" +
	"\fPortMapEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\x05R\x05value:\x028\x01\"\xc0\x01\n" +
	"\x02ID\x12B\n" +
	"\tcomponent\x18\x01 \x01(\x0e2$.clustermetadata.v1.ID.ComponentTypeR\tcomponent\x12\x12\n" +
	...
	"\aDRAINED\x10\x04B9Z7github.com/multigres/multigres/go/pb/clustermetadata/v1b\x06proto3"

var (
	file_clustermetadata_v1_clustermetadata_proto_rawDescOnce sync.Once
	file_clustermetadata_v1_clustermetadata_proto_rawDescData []byte
)

func file_clustermetadata_v1_clustermetadata_proto_rawDescGZIP() []byte {
	file_clustermetadata_v1_clustermetadata_proto_rawDescOnce.Do(func() {
		file_clustermetadata_v1_clustermetadata_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_clustermetadata_v1_clustermetadata_proto_rawDesc), len(file_clustermetadata_v1_clustermetadata_proto_rawDesc)))
	})
	return file_clustermetadata_v1_clustermetadata_proto_rawDescData
}

var file_clustermetadata_v1_clustermetadata_proto_enumTypes = make([]protoimpl.EnumInfo, 3)
var file_clustermetadata_v1_clustermetadata_proto_msgTypes = make([]protoimpl.MessageInfo, 11)
var file_clustermetadata_v1_clustermetadata_proto_goTypes = []any{
	(PoolerType)(0),          // 0: clustermetadata.v1.PoolerType
	(PoolerServingStatus)(0), // 1: clustermetadata.v1.PoolerServingStatus
	(ID_ComponentType)(0),    // 2: clustermetadata.v1.ID.ComponentType
	(*GlobalTopoConfig)(nil), // 3: clustermetadata.v1.GlobalTopoConfig
	(*Cell)(nil),             // 4: clustermetadata.v1.Cell
	(*Database)(nil),         // 5: clustermetadata.v1.Database
	(*MultiPooler)(nil),      // 6: clustermetadata.v1.MultiPooler
	(*MultiGateway)(nil),     // 7: clustermetadata.v1.MultiGateway
	(*MultiOrch)(nil),        // 8: clustermetadata.v1.MultiOrch
	(*ID)(nil),               // 9: clustermetadata.v1.ID
	(*KeyRange)(nil),         // 10: clustermetadata.v1.KeyRange
	nil,                      // 11: clustermetadata.v1.MultiPooler.PortMapEntry
	nil,                      // 12: clustermetadata.v1.MultiGateway.PortMapEntry
	nil,                      // 13: clustermetadata.v1.MultiOrch.PortMapEntry
}
var file_clustermetadata_v1_clustermetadata_proto_depIdxs = []int32{
	9,  // 0: clustermetadata.v1.MultiPooler.id:type_name -> clustermetadata.v1.ID
	10, // 1: clustermetadata.v1.MultiPooler.key_range:type_name -> clustermetadata.v1.KeyRange
	0,  // 2: clustermetadata.v1.MultiPooler.type:type_name -> clustermetadata.v1.PoolerType
	1,  // 3: clustermetadata.v1.MultiPooler.serving_status:type_name -> clustermetadata.v1.PoolerServingStatus
	11, // 4: clustermetadata.v1.MultiPooler.port_map:type_name -> clustermetadata.v1.MultiPooler.PortMapEntry
	9,  // 5: clustermetadata.v1.MultiGateway.id:type_name -> clustermetadata.v1.ID
	12, // 6: clustermetadata.v1.MultiGateway.port_map:type_name -> clustermetadata.v1.MultiGateway.PortMapEntry
	9,  // 7: clustermetadata.v1.MultiOrch.id:type_name -> clustermetadata.v1.ID
	13, // 8: clustermetadata.v1.MultiOrch.port_map:type_name -> clustermetadata.v1.MultiOrch.PortMapEntry
	2,  // 9: clustermetadata.v1.ID.component:type_name -> clustermetadata.v1.ID.ComponentType
...
func init() { file_clustermetadata_v1_clustermetadata_proto_init() }
func file_clustermetadata_v1_clustermetadata_proto_init() {
	if File_clustermetadata_v1_clustermetadata_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_clustermetadata_v1_clustermetadata_proto_rawDesc), len(file_clustermetadata_v1_clustermetadata_proto_rawDesc)),
			NumEnums:      3,
			NumMessages:   11,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_clustermetadata_v1_clustermetadata_proto_goTypes,
		DependencyIndexes: file_clustermetadata_v1_clustermetadata_proto_depIdxs,
		EnumInfos:         file_clustermetadata_v1_clustermetadata_proto_enumTypes,
		MessageInfos:      file_clustermetadata_v1_clustermetadata_proto_msgTypes,
	}.Build()
	File_clustermetadata_v1_clustermetadata_proto = out.File
	file_clustermetadata_v1_clustermetadata_proto_goTypes = nil
	file_clustermetadata_v1_clustermetadata_proto_depIdxs = nil
}
