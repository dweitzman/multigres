...
const file_query_v1_query_proto_rawDesc = "" +
	"\n" +
	"\x14query/v1/query.proto\x12\bquery.v1\"~\n" +
	"\vQueryResult\x12'\n" +
	"\x06fields\x18\x01 \x03(\v2\x0f.query.v1.FieldR\x06fields\x12#\n" +
	"\rrows_affected\x18\x02 \x01(\x04R\frowsAffected\x12!\n" +
	"\x04rows\x18\x03 \x03(\v2\r.query.v1.RowR\x04rows\"/\n" +
	"\x05Field\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x12\n" +
	"\x04type\x18\x02 \x01(\tR\x04type\"\x1d\n" +
	"\x03Row\x12\x16\n" +
	"\x06values\x18\x01 \x03(\fR\x06valuesB/Z-github.com/multigres/multigres/go/pb/query/v1b\x06proto3"
...
var file_query_v1_query_proto_goTypes = []any{
	(*QueryResult)(nil), // 0: query.v1.QueryResult
	(*Field)(nil),       // 1: query.v1.Field
	(*Row)(nil),         // 2: query.v1.Row
}
var file_query_v1_query_proto_depIdxs = []int32{
	1, // 0: query.v1.QueryResult.fields:type_name -> query.v1.Field
	2, // 1: query.v1.QueryResult.rows:type_name -> query.v1.Row
