...
type StatusResponse struct {
	...
	// The node's current consensus status: its coordinator promise, committed
	...
	// Best-effort operational fitness signals for this node. Distinct from
	// consensus_status (which is authoritative): these signals are in-memory and
	// may be absent after a process restart. Coordinators treat absence as
	// "unknown," not "unfit."
