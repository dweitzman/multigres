...
// TestSpuriousFailoverRecovery reproduces MUL-505: after a bootstrap that
...
// all cohort members, which emergency-demotes the current primary. The
...
// outgoing quorum required), which is what made the MUL-505 wedge durable.
