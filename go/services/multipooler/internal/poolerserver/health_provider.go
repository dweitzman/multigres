...
type HealthState struct {
	...
	// that qualifies it. role == PRIMARY is the writable signal (replacing the
	// former separate leader-observation + writable fields); role == REPLICA means
	// it is not the writable leader. May be nil before the role is established.
