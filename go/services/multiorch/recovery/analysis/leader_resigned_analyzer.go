...
// from LeaderUnreachableAnalyzer, which infers leader loss from reachability
// and health. Both signals are unambiguous, intentional indicators so
// failover can fire immediately with no follower-connection grace period.
