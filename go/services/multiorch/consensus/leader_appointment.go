...
func (c *Coordinator) EstablishLeadership(
	...
	leaderCfg, err := policy.BuildPrimaryDurabilityPostgresConfig(c.logger, cohortIDs, candidate.MultiPooler.Id)
	if err != nil {
	...
	if leaderCfg == nil {
		return mterrors.New(mtrpcpb.Code_INTERNAL,
			"BuildPrimaryDurabilityPostgresConfig returned nil config without error")
	}
