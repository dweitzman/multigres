...
func TestPoolerHealthSimpleCopy(t *testing.T) {
	...
	t.Run("copies all fields", func(t *testing.T) {
		...
		routingState := &clustermetadatapb.RoutingState{Role: clustermetadatapb.RoutingRole_ROUTING_ROLE_PRIMARY, Rule: &clustermetadatapb.RuleNumber{CoordinatorTerm: 42}}
