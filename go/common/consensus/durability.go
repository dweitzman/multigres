...
// BuildSimpleTransitionPolicy computes the PolicyTransition for a leader-led rule
...
// returns an error.
func BuildSimpleTransitionPolicy(outgoing, incoming PolicyWithCohort) (*PolicyTransition, error) {
