...
// This is a fixed implementation of dbconv.ClientConnectionCount which has a bug where
// it doesn't add pool name and state attributes when no extra attributes are provided.
//
// TODO: Switch to dbconv.ClientConnectionCount once the upstream bug is fixed.
// See: https://github.com/open-telemetry/opentelemetry-go/issues/XXXX
