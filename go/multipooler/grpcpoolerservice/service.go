...
func (s *poolerService) GetAuthCredentials(ctx context.Context, req *multipoolerpb.GetAuthCredentialsRequest) (*multipoolerpb.GetAuthCredentialsResponse, error) {
	...
	// The query uses a parameterized approach via string formatting since
	// we control the username validation
...
// This is a simple escape function for PostgreSQL that doubles single quotes.
